...
int decompress(const string& inpath, unsigned char *data, int size) {
	int ret;
	unsigned have;
	z_stream strm;
    unsigned char *in;
	unsigned char *out = new unsigned char[size];
	std::FILE *source;
	//fopen_s(&source, "C:\\38370_49200\\40.8790234954071_-74.61353423782953_0_0_f_c.bin", "rb");
	...
	std::cout<< "eof: "<<fseek(source, 0, SEEK_END)<<std::endl;
